...
testdata = [Project(name=random_strings("name", 10), status=random_status(), view_status=random_view_status(),
                    igc=random_boolean(), description=random_strings("description", 30))
    for name in range(n)
]
